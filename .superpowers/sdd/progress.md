...
- [x] Task 4: Finite State Machine Control Logic (commit 71d0caa, compilation verified)
...
*   Task 3: Replace floating point math `duration * 0.0343 / 2.0` with `duration / 58` in distanceRead() to save ~1.5KB of Flash and improve execution speed on AVR.
